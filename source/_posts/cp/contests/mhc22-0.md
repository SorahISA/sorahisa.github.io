...
[AC Solution ($\texttt{unordered\_map}$)](https://github.com/SorahISA/competitive_programming/blob/master/(MHC)%20Meta%20Hacker%20Cup/2022/Qualification%20Round/mhc22-0D-2.cpp)
...
- 定義一個 threshold $B$，把度數 $\ge B$ 的叫做阿姨，$< B$ 的叫ㄌㄌ。
    - 如果 $X_j$ 是ㄌㄌ：直接衝上去，反正ㄌㄌ的複雜度夠小，只有 $\mathcal{O}(B)$。
...
- 分數：<span class="score_ac">$100$ 分</span>
- 排名：<span class="medal_au">$11 / 27\,603$ 名</span>
